var automapper = (function (app) {
	...
	exports = app.automapper = {};
	
	var dictionary = {};
	
	exports.createMap = function (sourceKey, destinationKey) {
	...
	exports.map = function (sourceKey, destinationKey, sourceValue, destinationValue, lazy) {
